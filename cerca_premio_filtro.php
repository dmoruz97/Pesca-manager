...
<html lang="it" xmlns="http://www.w3.org/1999/xhtml" xml:lang="it">
    ...
    <body>
        ...
        <?php
            ...
            $sql_select = "SELECT numero,nome,posizione,descrizione FROM premi WHERE numero LIKE '%$in%' OR nome LIKE '%$in%' OR posizione LIKE '%$in%'";
            $result = mysqli_query($connection, $sql_select);

            $rows = mysqli_num_rows($result);
            if ($rows == 0){
                echo "<div class=\"warning\">NESSUN PREMIO CORRISPONDENTE!</div>";
            }
            else {
                echo "
                ...
                while ($row) {
                    ...
                    if ($conta == 1){
                        echo "<tr>\n
                                ...
                                <td class='action'><a onclick=\"riconosciBottone('" . $id . "x1')\"><img title=\"Modifica premio\" width=\"30\" height=\"30\" src=\"img/edit.png\"></a></td>\n
                                <td class='action'><a onclick=\"riconosciBottone('" . $id . "x2')\"><img title=\"Rimuovi premio\" width=\"30\" height=\"30\" src=\"img/delete.png\"></a></td>\n
                              </tr>\n
                            ";
                    }
                    else if ($conta <= 5){
